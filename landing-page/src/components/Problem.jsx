          ...
          {problems.map((problem, idx) => {
            ...
            return (
              <motion.div
                ...
                className="p-8 rounded-xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-gray-700/50 backdrop-blur-sm hover:border-gray-600/80 transition duration-300 group cursor-pointer"
              >
